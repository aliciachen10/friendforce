...
function DashboardProfile() {
    ...
    const editPalette = "flex justify-between bg-gray-100 border-gray-200 border-2 rounded-md p-1";
    const readonlyPalette = "flex justify-between bg-gray-100 border-gray-100 border-2 rounded-md p-1";
